...
func createPlace(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "Error reading places file", http.StatusInternalServerError)
		return
	}

	var places []Place
	if err := json.Unmarshal(file, &places); err != nil {
		http.Error(w, "Error parsing places file", http.StatusInternalServerError)
		return
	}
	...
	if err := os.WriteFile("places.json", data, 0644); err != nil {
